...
s3cmd --no-mime-magic --guess-mime-type --config="$S3_CONFIG" $DRY_RUN --force --recursive $DELETE_REMOVED --bucket-location=$S3_REGION --progress --acl-public sync web/ s3://$S3_BUCKET
